...
create table silver.crm_cust_info(
	...
	dwh_create_date datetime2 default getdate()   --datetime2 shows date and time, default getdate() means that no value is specified at time of insert 
	                                              --so it auto inserts the current time(getdate())
); 
